...
# Check if the number of samples in FACES matches LABELS
if len(FACES) != len(LABELS):
    raise ValueError("Number of samples in faces_data.pkl does not match number of labels in names.pkl")
